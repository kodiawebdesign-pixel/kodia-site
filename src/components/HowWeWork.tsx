        ...
        <div className="absolute top-[88px] left-0 right-0 hidden lg:flex justify-between px-4">
          {w.steps.map((_, idx) => (
            <motion.div
              ...
              className={`w-4 h-4 rounded-full bg-gradient-to-r ${gradientColors[idx % gradientColors.length]} shadow-lg`}
            />
          ))}
        </div>
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl border border-gray-200/50 p-6 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-r ${gradient} text-white text-sm font-bold shadow-lg`}>
                      {idx + 1}
                    </span>
                  </div>
                  ...
                  >
                    <div className="space-y-2 pt-2 border-t border-gray-100">
                      {features.map((feature, fidx) => (
                        ...
                        >
                          <CheckCircle2 className={`w-4 h-4 bg-gradient-to-r ${gradient} text-white rounded-full p-0.5`} />
                          {feature}
                        </motion.div>
                      ))}
                    </div>
                  ...
                  <div className="mt-4 flex items-center gap-2 text-xs text-gray-500">
                    ...
                    <span>المدة: {idx + 1} - {idx + 3} أيام</span>
                  </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-4">
              منهجية عمل <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">احترافية</span>
            </h3>
            <p className="text-gray-600 mb-6">
              نتبع خطوات واضحة ومنظمة لضمان تنفيذ مشروعك بأعلى جودة وفي الوقت المحدد. 
              كل خطوة تخضع للمراجعة والتقييم قبل الانتقال للخطوة التالية.
            </p>

            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "خطوة منظمة", value: w.steps.length },
              ...
              >
                ...
                <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    className={`h-full bg-gradient-to-r ${gradientColors[idx]} rounded-full`}
                  />
                </div>
              </motion.div>
            ))}
