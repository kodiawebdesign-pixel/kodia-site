          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex flex-col md:flex-row gap-8 items-start">
                {/* الشعار (يمكن إضافة شعار حقيقي لاحقاً) */}
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {siteData.home.guarantees.items.map((guarantee, idx) => {
                  // التأكد من أن guarantee نص
                  const guaranteeText = typeof guarantee === 'string' 
                    ? guarantee 
                    : (guarantee as any).text || JSON.stringify(guarantee);
                  
                  return (
                    <div key={`guarantee-${idx}-${guaranteeText.substring(0, 20)}`} className="flex items-start gap-2 text-sm">
